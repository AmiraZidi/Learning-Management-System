                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="modal-header modal-header-info">
                                                        <h6 class="text-left" style="color:#4e73df;"><b>Envoyer un message</b></h6>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="form-group row">
                                                            <label for="sujet" class="col-sm-2 col-form-label">
                                                                <span class="glyphicon glyphicon-list-alt"></span>Enseignant
                                                            </label>
                                                            <div class="col-sm-10">
                                                                <select name="sujet" id="sujet" class="form-control">
                                                                    <!--tabda l foreach menna -->
                                                                    <option value="événement">ens 1</option>
                                                                    <option value="Avis de rattrappage">ens 2</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label" for="inputTo">Sujet</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" name="sujet" placeholder="Entrer le Sujet" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
