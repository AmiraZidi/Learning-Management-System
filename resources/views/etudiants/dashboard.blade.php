                                ...
                                <div class="row" >
                                    <div class="card shadow mb-4" style="width: 99%;">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Bienvenue cher(e) étudiant(e)!</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <p align="left">
                                                    Bienvenue sur la plateforme LMS de l'Institut Supérieur des Études Technologiques (ISET) de Gabès , Dédiée à l'accompagnement des étudiants du département Sciences et Technologies de l'Information et de la Télécommunication (STIC), notre plateforme vise à fournir une expérience d'apprentissage de qualité et à préparer les étudiants pour un avenir prometteur.
                                                    </p>
                                                </div>
