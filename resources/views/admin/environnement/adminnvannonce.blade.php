    ...
    <div class="row">
        <div class="card shadow mb-4" style="width: 99%;">
            ...
            <div class="tab-pane " id="demandes" role="tabpanel" aria-labelledby="demandes-tab">
                <form action="{{route('adminnvannoncepost')}}" method="post">
                    @csrf
                                                        ...
                                                        <div class="mr-3"><i class="icofont-ui-home icofont-3x"></i></div>
                                                            ...
                                                            <div class="media-body">
                                                                <div class="modal-header modal-header-info">
                                                                    <h6  align="left" class="text-primary"><b>Partager une Annonce </b></h6>
                                                                </div>
                                                                <div class="modal-body">
                                                                   
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-2" for="inputTo" align="left"><span class="glyphicon glyphicon-user"></span>Titre</label>
                                                                        <div class="col-sm-10"> <input type="text" class="form-control" name="titre" title="Entrer le titre" required> </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-2" for="inputBody" align="left"><span class="glyphicon glyphicon-list"></span>Contenu</label>
                                                                        <div class="col-sm-10">
                                                                            <textarea class="form-control" name="contenu" id="inputBody" rows="8" required></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
