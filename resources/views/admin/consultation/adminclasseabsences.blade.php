                    ...
                    @if ($affectations)
                        @foreach ($affectations as $affectation)
                            <tr>
                                ...
                                <td><a class="btn btn-info btn-circle btn-lg form-control " href="{{route('adminseancesabsences' , $affectation->id)}}"   style="font-size: 0.5em;">Historique des absences</a></td>
                                <td><a class="btn btn-warning btn-circle btn-lg form-control" href="{{route('adminnotes' , $affectation->id)}}"    style="font-size: 0.5em;">Historique des notes</a></td>
                                <td><a class="btn btn-success btn-circle btn-lg form-control" href="{{route('admincours' , $affectation->id)}}" style="font-size: 0.5em;">Historique des cours</a></td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
