...
<head>
  ...
  <title>Email du confirmation compte</title>
  <style>
    body, .clean-body {
      margin: 0;
      padding: 0;
...
<table id="u_content_heading_1" role="presentation" cellpadding="0" cellspacing="0" width="80%" border="0">
  <tbody>
    ...
    <h1 style="color:#ffffff;"><span><span><span><span><span><strong>Détails sur votre compte </strong><br><br></span></span></span></span></span></h1>
    <h4 style="color:#ffffff;"><span><span><span><span><span><strong> Madame/Monsieur :{{ $details['name'] }}</strong></span></span></span></span></span></h4>
...
<table id="u_content_text_1" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#ffffff;">
  ...
  <div>
    <p style="color:#ffffff;">Bienvenue ,</p>
<p style="color:#ffffff;">E-mail : {{ $details['email'] }}</p>
<p style="color:#ffffff;">Mot de passe : {{ $details['password'] }}</p>
...
<div class="v-text-align" align="left">
  <a href="http://127.0.0.1:8000/" target="_blank">
    <span><span>Consulter votre profile</span></span>
  </a>
</div></td>
</tr>
  </tbody>
