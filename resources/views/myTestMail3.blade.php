...
<head>
  ...
  <title>Nouvelle Annoncée Partagée</title>
  <style>
    body, .clean-body {
      margin: 0;
      padding: 0;
...
<table id="u_content_heading_1" role="presentation" cellpadding="0" cellspacing="0" width="80%" border="0">
  <tbody>
    ...
    <h3 style="color:#ffffff;"><span><span><span><span><span><strong>Nouvelle annonce </strong><br><br><strong>partagée par {{ $details['name'] }}</strong></span></span></span></span></span></h3>
    <h1 style="color:#ffffff;"><span><span><span><span><span><strong> {{ $details['titre'] }}</strong></span></span></span></span></span></h1>
...
<table id="u_content_text_1" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#ffffff;">
  ...
  <div>
<p style="color:#ffffff;">{{ $details['contenu'] }}</p>
...
<div class="v-text-align" align="left">
  <a href="http://127.0.0.1:8000/" target="_blank">
    <span><span>Consulter l'annonce</span></span>
  </a>
</div></td>
</tr>
  </tbody>
