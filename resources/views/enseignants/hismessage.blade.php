...
<div class="container my-4">
    <div class="card shadow mb-4">
        <div class="card-header py-3 border-bottom-info text-center text-primary">
            <h6 class="m-0 font-weight-bold">Historique des messages</h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-striped" id="myTable2">
                    <thead>
                        <tr>
                            ...
                            <th onclick="sortTable(2)">Envoyé par </th>
                            <th>Date</th>
                        </tr>
                        @foreach($messages as $message)
                        <tr>
                            <td>{{ $message->sujet }}</td>
                            <td>{{ $message->message }}</td2>
                            <td class="text-info">{{ $message->etudiant->name }}</td>
