                ...
                @if ($affectations)
                    @foreach ($affectations as $affectation)
                        <tr>
                            ...
                            <td><button class="btn btn-info btn-circle btn-lg" onclick="addnote('{{$affectation->id}}')" style="font-size: 0.5em;">Attribuer des notes</button></td>
                        </tr>
                    @endforeach
                @else
                    <tr>
...
<script>
    ...
    function addnote(id) {
        window.location.href = "{{ url('enseignants/addnote') }}/" + id;
    }
