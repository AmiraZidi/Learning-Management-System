            ...
            <div class="card-header py-3">
                <div class="border-bottom p-4">
                    <div class="osahan-user text-center">
                        ...
                        <img class="mb-3 rounded-pill shadow-sm mt-1" src="{{ asset('img/' . $enseignant->image) }}" alt="image" style="width: 300px; height: auto;">
                            <div class="osahan-user-media-body">
                                <h6 class="mb-2">{{ $enseignant->name }} </h6>
                                <p class="mb-1">{{ $enseignant->specialite_enseignant}}</p>
                                <p>{{ $enseignant->email }}</p>
                                <a href="{{route('changermotdepasse2')}}" >Changer votre mot de passe</a>  <br><br>
                                <a href="{{url ('enseignants/edit')}}" class="btn btn-primary btn-block">Modifier votre profile</a> 
                            </div>
                        </div>
                    </div>
                </div>
